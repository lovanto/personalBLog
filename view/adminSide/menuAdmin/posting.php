			...
			<tbody>
				...
				while ($show = mysqli_fetch_array($sql)) {
					...
					<tr id="showDataHere">
						...
						<td><a href="menuAdmin/update_post_view.php?id_post=<?php echo $show['id_post'];?>">Edit</a> | <a href="../../code/delete.php?type=post&id_post=<?php echo $show['id_post'];?>">Hapus</a></td>
					</tr>
					<?php
				}
				?>
