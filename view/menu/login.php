<div>
	...
	<hr>
	<div>
		<form method="POST" action="code/login_process.php" enctype="multipart/form-data">
			<input type="text" name="usernameLogin" class="form-control" style="margin-bottom: 10px;" placeholder="Username">
