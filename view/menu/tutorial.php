	...
	<nav aria-label="...">
		<ul class="pagination justify-content-center">
			...
			if ($page == 1){
				...
				?>
				"><a class="page-link" href="?page=tutorial&pageNumber=1"
				">Pertama</a>
			</li>
			...
			if ($page == 1){
				...
				?>
				"><a class="page-link" href="?page=tutorial&pageNumber=<?=$minusPage?>"><<</a>
				</li>
				...
				for ($pagee=$minPage; $pagee<=$maxPage; $pagee++){			
					...
					if ($locPage == $pagee){
						...
						?>
						"><a class="page-link" href="?page=tutorial&pageNumber=<?=$pagee?>"><?php echo $pagee; $locPage = (isset($_GET['pageNumber']))? $_GET['pageNumber'] : $pagee;?></a>
						</li>
						<?php
					} 
					?>
					...
					if ($page == $pages){
						...
						?>
						"><a class="page-link" href="?page=tutorial&pageNumber=<?=$plusPage?>">>></a>
						</li>
						...
						if ($page == $pages){
							...
							?>
							"><a class="page-link" href="?page=tutorial&pageNumber=<?=$pages?>">Terakhir</a>
							</li>
						</ul>
					</nav>
				</div>